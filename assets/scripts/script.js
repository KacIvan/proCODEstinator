let phrases = [
    { text: 'отправить бро смешную гифку', image: './assets/ideas_img/1.gif' },
    { text: 'купить билеты в кино', image: './assets/ideas_img/2.png' },
    { text: 'залипнуть в Ютуб', image: './assets/ideas_img/3.png' },
    { text: 'смотреть случайный ролик в рекомендациях', image: './assets/ideas_img/4.png' },
    { text: 'читать книги прямо в книжном магазине', image: './assets/ideas_img/5.png' },
    { text: 'читать про зарплаты разработчиков в Сан-Франциско', image: './assets/ideas_img/6.png' },
    { text: 'проскролить ленту новостей', image: './assets/ideas_img/7.png' },
    { text: 'слушать поток ностальгических песен и вспоминать ошибки молодости', image: './assets/ideas_img/8.png' },
    { text: 'посмотреть трейлер сериала... ну и сразу первый сезон', image: './assets/ideas_img/9.png' },
